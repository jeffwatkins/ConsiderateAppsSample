...
public class FlexibleHeader: Component, HeaderComponent {
    ...
    func titleWillTruncate() -> Bool {
        ...
        let fullTextRect = title.textRect(forBounds: measureBounds, limitedToNumberOfLines: 0)
        let textRect = title.textRect(forBounds: measureBounds, limitedToNumberOfLines: 2)
        return fullTextRect.height > textRect.height;
    }
